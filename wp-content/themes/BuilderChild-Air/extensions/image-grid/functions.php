						...
						<?php while ( have_posts() ) : the_post(); // the loop ?>
							<?php if ( has_post_thumbnail() ) : ?>
								...
								<div class="grid_wrapper entry-content">
									<div class="inner">
										<div class="image-grid-image-wrapper">									
											<a href="<?php echo $galleryurl[0]; ?>" class="it-gallery-thumb clearfix" rel="gallery-images"><?php the_post_thumbnail( 'it-gallery-thumb', array( 'class' => 'it-gallery-thumb' ) ); ?></a>
										</div>
										<p class="slide_box">
